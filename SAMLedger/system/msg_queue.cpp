...
{
    // cout << "ZS1: enqueue"<<endl;
    if(msg->get_rtype() == CL_RSP){
    //cout << "test_v7:enqueue, msg->is_cross_shard = " << ((ClientResponseMessage *)msg)->is_cross_shard << "\n";
    //cout << "test_v7:enqueue, msg->is_cross_shard = " << msg->is_cross_shard << "\n";
    }

    msg_entry *entry = (msg_entry *)mem_allocator.alloc(sizeof(struct msg_entry));
    new (entry) msg_entry();
    // cout << "ZS2: enqueue"<<endl;
    ...
    */
    ...
    case KEYEX:
        break;
    case CL_RSP:
        //cout << "test_v7:CL_RSP, msg->is_cross_shard = " << entry->msg->is_cross_shard << "\n";
    ...
    case CL_BATCH:
#if ZS
        if(((ClientQueryBatch *)msg)->do_or_pending==1){
            break;
        }
#endif
    ...
    case CL_BATCH:
    {
        ...
        if(msg->get_rtype() == CL_RSP){
            //cout << "test_v7:enqueue2 , msg->is_cross_shard = " << entry->msg->is_cross_shard << "\n";
        }
