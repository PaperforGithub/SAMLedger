...
extern uint64_t g_cross_shard_prob;
#endif
#if MULTI_CLIENT_SEND_RATE
extern double g_client_send_rates_ctrl[];  // 声明数组
#endif
#if RANDOM_CHOOSE_SHARD
extern double g_random_choose_shard_prob[];  // 声明数组
#endif
#if RANDOM_CHOOSE_NO_CROSS
extern double g_random_choose_no_cross_shard_prob[];  // 声明数组
#endif
#if SHARPER_ZS1
extern double g_sharper_zs1[2];
#endif
