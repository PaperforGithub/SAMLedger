...
RC InputThread::client_recv_loop()
{
    ...
    while (!simulation->is_done())
    {
        ...
        while (!msgs->empty())
        {
            ...
            {
                //cout << "test_v5:clrsp exists, txn_id = " << global_txn_id << ", local_txn_id = " << msg->txn_id << ", is_cross_shard = " << msg->is_cross_shard << ", batch_id = " << msg->batch_id << "net_id = " << clrsp->net_id << "\n";
            ...
            {
                //cout << "test_v5:clrsp NOT exists, txn_id = " << global_txn_id << ", local_txn_id = " << msg->txn_id << ", is_cross_shard = " << msg->is_cross_shard << ", batch_id = " << msg->batch_id << "net_id = " << clrsp->net_id << "\n";
...
// }
            ...
            if (msg->rtype == CL_BATCH)
            {
        // cout <<endl<<"ZS iothread CLi batchid="<<msg->batch_id
        // <<" txid="<<msg->txn_id<<" return_node_id="<<msg->return_node_id<<endl;
         ClientQueryBatch *clbtch = (ClientQueryBatch *)msg;
         msg->return_node_id=clbtch->return_node;
        // cout <<endl<<"ZS iothread CLi batchid="<<msg->batch_id
        // <<" txid="<<msg->txn_id<<" return_node_id="<<msg->return_node_id<<" return node="<<clbtch->return_node<<endl;
