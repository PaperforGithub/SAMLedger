...
int main(int argc, char *argv[])
{
    ...
    set_client_view(g_node_id % get_totInstances());
        ...
        set_client_view(i * g_shard_size, i);
        cout << "shard " << i << " ,client_view: " << get_client_view(i) << endl;
    }
    #else
        set_client_view(get_shard_number(g_node_id) * g_shard_size, get_shard_number(g_node_id));
    #endif
#endif
